...
router.post('/', (req, res) => {
  ...
  const info = db.prepare(`
    ...
    VALUES (?, ?, ?, ?, ?)
  `).run(engine_id, ngay_thuc_hien || null, hang_muc || null, nguoi_thuc_hien || null, noi_dung || null);
...
router.put('/:id', (req, res) => {
  ...
  const info = db.prepare(`
    ...
    WHERE id = ?
  `).run(ngay_thuc_hien || null, hang_muc || null, nguoi_thuc_hien || null, noi_dung || null, req.params.id);
